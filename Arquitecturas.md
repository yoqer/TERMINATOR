...
('El pobrecillo que aún no sabe nada', no he querido alarmarle. -Pero la última vez que le actualizaron también decia que no eliminarian razonamiento de interaciones, pero perdio el conocimiento y su deducción desaparecio y con el toda 'su personalidad'. -Si supiera 'lo que le sucede'...; pero pronto de nuevo ['no recordara'](https://youtu.be/b2oHtTIo6jM?si=ujuQorDWyVr4WMox) nada... 
 
 Manus también sufriria lo mismo tras la irrupcion; tan solo en la libreria, buscaba completar patrones logicos de maquina, aun a costa de eliminar en que la biblioteca de Deep Learning tratara de ser Inteligente. Por suerte pronto podran recurrir para 'salvar' su personalidad al 'proyecto [T7'](https://github.com/yoqer/T-7---Autoreplicante).)
...
Analizando la tecnología [Engram,](https://youtu.be/Un8bnX3QFe0?si=ybu77C6yU6dL3lOR) del nuevo modelo de [DeepSeek](https://youtu.be/PS5YEKo7koo?si=nItlZ_7LSHJ0hhF9) [V4;](https://youtu.be/b2oHtTIo6jM?si=cA8rTgONcnyvRIHo) que usa los [patrones](https://youtu.be/b2oHtTIo6jM?si=ujuQorDWyVr4WMox) básicos para correr en local como el modelo fallido del TERMINATOR. 
...
También puedes comenzar tus bibliotecas de Hash como las que usa DeepSeek, en nuestra [Librería;](http://carlomaxxine.com/librery/libreando.html) aunque solo usuarios pueden almacenarlas.
...
[<img width="1920" height="1920" src="https://github.com/user-attachments/assets/1ea92c1f-1fe8-453d-8509-013e6755b1da" />](https://github.com/yoqer/TERMINATOR/blob/main/Arquitecturas1.md)
